  ...
  util.loadCorpora = function() {
    ...
    window.corpusChooserInstance = $("#corpusbox").corpusChooser({
      ...
      infoPopup: function(corpusID) {
        var baseLang, baseLangSentenceHTML, baseLangTokenHTML, baseLangs, corpusObj, lang, lastUpdate, maybeInfo, numSentences, numTokens, output, sentenceString, supportsContext, _i, _len, _ref;
