(function() {
  ...
  view.KWICResults = (function(superClass) {
    ...
    KWICResults.prototype.buildQueryOptions = function(cqp, isPaging) {
      var avoidContext, context, getSortParams, opts, pq_within, preferredContext;
      ...
      util.addCQPs(opts.ajaxParams, cqp || this.proxy.prevCQP || this.proxy.prevParams);
      pq_within = "cqp1" in opts.ajaxParams ? $("#prequery_within").val() : void 0;
      _.extend(opts.ajaxParams, {
        defaultwithin: pq_within
      });
  ...
  view.StatsResults = (function(superClass) {
    ...
    StatsResults.prototype.renderResult = function(columns, data) {
      ...
      this.s.stats_num_values_display = util.prettyNumbers(data.length - 1);
  ...
  view.GraphResults = (function(superClass) {
    ...
    function GraphResults(tabSelector, resultSelector, scope) {
      ...
      $(".chart", this.$result).on("click", (function(_this) {
        return function(event) {
          var cqp, datefrom, dateto, k, m, n_tokens, opts, results, target, timecqp, timefrom, timeto, val, year;
