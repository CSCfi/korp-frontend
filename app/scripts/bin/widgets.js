...
(function() {
  ...
  Sidebar = {
    ...
    renderItem: function(key, value, attrs, token_data) {
      ...
      value = attrs.stringify_synthetic ? attrs.stringify_synthetic(token_data) : (attrs.stringify || _.identity)(value);
      if (attrs.type === "url") {
  ...
  KorpTabs = {
    _init: function() {
      ...
      this.element.on("click", ".tabClose", (function(_this) {
    ...
    enableAll: function() {
      return $.each(".custom_tab", (function(_this) {
  ...
  ExtendedToken = {
    ...
    _init: function() {
      ...
      this.element.find(".insert_arg").click((function(_this) {
        return function() {
      ...
      return this.element.find(".repeat input").change((function(_this) {
        return function() {
