...
(function() {
  ...
  Sidebar = {
    ...
    renderItem: function(key, value, attrs, token_data) {
      var address, getStringVal, inner, itr, li, link_text, lis, output, pattern, prefix, str_value, target, ul, url, val, valueArray, x, _ref, _ref1, _ref2;
      ...
      if (attrs.type === "url") {
        ...
        link_text = (attrs != null ? (_ref2 = attrs.url_opts) != null ? _ref2.hide_url : void 0 : void 0) ? "<span rel='localize[" + attrs.label + "]'>" + key + "</span>" : decodeURI(str_value);
