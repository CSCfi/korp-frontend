...
sattrs.yle_sv_common = {
    ...
    text_date_published : sattrs.text_pubdate,
    text_date_content_modified : {
	label : "date_content_modified",
    },
    text_date_json_modified : {
	label : "date_json_modified",
    },
    // paragraph_id : {
    // },
    // sentence_id : {
...
settings.corpora.yle_sv_sample = {
    ...
    licence_type : "ACA",
    attributes : {},
    struct_attributes : sattrs.yle_sv_common,
};

settings.corpora.yle_sv_pub = {
    title : "Svenska YLEs webbartiklar 2012– (PUB)",
    description : "Svenska YLEs webbartiklar 2012– (scrambled, ingen styckkontext)",
    id : "yle_sv_pub",
    urn : "[to be added]",
    metadata_urn : "urn:nbn:fi:lb-2016111401",
    licence : settings.licenceinfo.CC_BY,
	...
	{}, sattrs.yle_sv_common,
	{
	    sentence_paragraph_type : sattr.yle_sv_paragraph_type,
	}),
};

settings.corpora.yle_sv_aca = {
    title : "Svenska YLEs webbartiklar 2012– (ACA)",
    description : "Svenska YLEs webbartiklar 2012– (original, med styckkontext)",
    id : "yle_sv_aca",
    urn : "[to be added]",
    metadata_urn : "urn:nbn:fi:lb-2016111401",
    licence : settings.licenceinfo.ACA_NC,
	...
	{}, sattrs.yle_sv_common,
	{
	    paragraph_type : sattr.yle_sv_paragraph_type,
	}),
};
